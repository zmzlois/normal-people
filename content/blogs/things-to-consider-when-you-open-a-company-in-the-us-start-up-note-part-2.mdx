...
postSlug: Things-to-consider-when-you-register-a-company-in-the-us-from-abroad
featured: true
draft: false
tags:
  - learning-notes
  - startups
ogImage: "https://miro.medium.com/v2/resize:fit:1400/0*gF1C5kLLzC9B1INr"
description:
  Although this article is targeting Taiwanese, I found 80% of it informative for start-up founders who are interested in getting investment from the US.
---

[![Lois Z.](https://miro.medium.com/v2/resize:fill:88:88/1*mNpyQjptIh3VCarIzRwkUA.jpeg)

](https://medium.com/@zmzlois?source=post_page-----4b3213e91127--------------------------------)
