...
date: 2022-11-19
type: Blog
title: A useful list for start ups
featured: false
published: true
description: "Learning note."
tags: ["startup", "notes", "tools"]
---
...
- [rebar](https://github.com/MachineAcuity/rebar): Multi-tenant SaaS boilerplate + examples for universal web application with React, Material-UI, Relay, GraphQL, JWT, Node.js, Cassandra and other NoSQL DB.
...
> Inspired by [Terry Lennon](https://medium.com/u/8b852ac51b5c?source=post_page-----1bb137cb94e4--------------------------------)
