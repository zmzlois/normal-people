...
import { Companies, Volunteer, Education } from "../../app/intro/config";

import type {
  CompanyType,
  VolunteerType,
  EducationType,
} from "../../app/intro/config";
...
function Right() {
  return (
    <div className="flex flex-col col-span-2 text-slate-50">
      <div className="space-y-8">
        <div className="text-slate-50">
          <h1 className=" text-lg font-bold sm:text-2xl text-sky-400">
