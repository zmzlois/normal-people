          ...
          <li className="mb-6" key={index}>
            <a href={item.slug}>
              <div className="group relative rounded-xl bg-zinc-900 overflow-hidden px-[0.6px] pb-[1.02px] pt-[1px] lg:hover:!opacity-100 transition-all lg:group-hover/list:opacity-30">
                ...
                />
                <div className="z-10 px-5 relative lg:hover:ring ring-slate-500/50 rounded-xl py-6 bg-zinc-900 grid  transition-all sm:grid-cols-8 border  sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:hover:bg-zinc-800 ">
                  {item.time && (
                  ...
                  {item.image && (
                    <header className="z-10 mb-2 mt-1 sm:col-span-2 h-full border flex justify-self-center">
                      <img src={item.image}></img>
                    </header>
                  )}
                  <div className="z-10 sm:col-span-6">
                    <h3 className="sm:font-medium font-normal leading-snug  hover:text-cyan-300 group-hover:!text-cyan-300 group-hover/list:text-cyan-300 focus-visible:text-cyan-300  text-slate-200 sm:text-base text-sm mb-2 lg:mb-0">
