...
export const navigation: NavigationType[] = [
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="border border-slate-100 rounded-full py-[2px]"
          />
        ),
        name: "Next.js",
      },
      ...
      },
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="py-[2px] rounded-full bg-slate-100"
          />
        ),
        name: "PrismaORM",
      },
      {
        icon: (
          <T3 className="w-6 h-6 border border-slate-100 rounded-full p-[2px]" />
        ),
        name: "Create T3 App",
      },
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="rounded-full bg-slate-100 py-[2px]"
          />
        ),
        name: "Astro.build",
      },
    ...
    content: [
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="rounded-full bg-slate-100 p-[2px]"
          />
        ),
        name: "AWS",
      },
      ...
      },
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="p-[1px] border rounded-full border-slate-50"
          />
        ),
        name: "MySQL",
      },
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="rounded-full bg-slate-50 p-[1px]"
          />
        ),
        name: "Kafka",
      },
      ...
      },
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="rounded-full bg-slate-950 p-[2px]"
          />
        ),
        name: "Expo",
      },
    ...
    content: [
      {
        icon: (
          <Icon
            ...
            width="24"
            height="24"
            className="p-[2px] bg-slate-200 rounded-full"
          />
        ),
...
export const siteConfig = {
  ...
  intro:
    "Self-taught engineer. Writer. TEDx Speaker. Crossfitter. Entrepreneurial. Behavioral Finance Graduate.",
};
