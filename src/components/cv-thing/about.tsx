export const About = () => {
  return (
    <p
      id="about"
      className="text-slate-300 font-light tracking-wide leading-relaxed"
    >
      How it all started? I had the courage to tackle a Python course offered by{" "}
      <a
      ...
      prices. After thousands of documents ran through my fingers in a blink of
      an eye, I started to dive into web development. <br /> <br />
